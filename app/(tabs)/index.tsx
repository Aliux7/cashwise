...
export default function Index() {
  ...
  const selectedLabel = useSharedValue("Mon");
  ...
  const transactions = [
    { id: 1, title: "Coffee", date: "Apr 7, 2025", amount: -3.5 },
    { id: 2, title: "Salary", date: "Apr 6, 2025", amount: 2000 },
    { id: 3, title: "Groceries", date: "Apr 6, 2025", amount: -45.8 },
    { id: 4, title: "Electric Bill", date: "Apr 5, 2025", amount: -60.25 },
    { id: 5, title: "Electric Bill", date: "Apr 5, 2025", amount: -60.25 },
    { id: 6, title: "Electric Bill", date: "Apr 5, 2025", amount: -60.25 },
    { id: 7, title: "Electric Bill", date: "Apr 5, 2025", amount: -60.25 },
  ];
    ...
    <View className="flex-1 justify-center items-center bg-white">
      ...
      <ScrollView className="w-full flex-1" stickyHeaderIndices={[0, 1]}>
          ...
          <View className="flex flex-row mx-5 gap-4">
            <View className="flex-1 h-20 shadow-xl rounded-md overflow-hidden border border-green-200">
              ...
              >
                ...
                <Text className="text-lg text-green-600 mt-0.5">
                  Rp. 10.000.000,00
                </Text>
              </LinearGradient>
            </View>
        ...
        <View className="p-5 bg-white shadow-xl mt-5 rounded-t-3xl border-t border-x border-blue-100">
          <Text className="text-gray-500">Recent Transaction</Text>
